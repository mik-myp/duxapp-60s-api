    ...
    switch (key) {
      case 'button': {
        ...
        if (value.sizes) {
          Object.keys(value.sizes).forEach((size) => {
            ...
            scssData.button.push(
              `$duxuiButton${size.toUpperCase()}FontSize: ${fs}px;`
            );
            scssData.button.push(
              `$duxuiButton${size.toUpperCase()}Padding: ${p}px;`
            );
            scssData.button.push(
              `$duxuiButton${size.toUpperCase()}Height: ${h}px;`
            );
          });
        }
        break;
      ...
      case 'tabBar': {
        ...
        if (value.nameHoverColor) {
          scssData.tabBar.push(
            `$duxuiTabBarNameHoverColor: ${value.nameHoverColor};`
          );
        }
        break;
      }
      ...
      case 'formItem': {
        ...
        if (value.labelWidth !== undefined) {
          scssData.formItem.push(
            `$duxuiFormItemLabelWidth: ${value.labelWidth}px;`
          );
        }
        break;
      }
