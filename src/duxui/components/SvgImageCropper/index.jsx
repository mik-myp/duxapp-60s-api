...
export const SvgImageCropper = forwardRef(
  ({ src, width = 300, height = 300, format, quality }, ref) => {
      ...
      >
        <SvgToImage ref={ref} options={{ format, quality }}>
          <Svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
            <G scale={config.scale} translateX={config.x} translateY={config.y}>
              <Image
                href={{ uri: src }}
                width={displayWidth}
...
const SvgImageCropperContent = ({
  ...
  return (
    <PullView side='center' ref={pull} onClose={onClose}>
