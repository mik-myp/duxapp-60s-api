...
export const ColorPicker = ({
  ...
  return (
    <Column className={classNames('gap-2', className)} style={style} {...props}>
      <Svg disabledScroll width={size} height={size}>
        ...
        <Rect width={size} height={size} fill={`hsl(${hue}, 100%, 50%)`} />
        <Rect width={size} height={size} fill='url(#saturation)' />
        <Rect width={size} height={size} fill='url(#value)' />
        <Circle
          cx={saturation * size}
          cy={(1 - value) * size}
          r={8}
      ...
      <Svg width={size} height={20} disableScroll>
        ...
        <Rect width={size} height={20} fill='url(#hue)' />
        <Rect
          x={(1 - hue / 360) * size - 2}
          width={4}
          height={20}
