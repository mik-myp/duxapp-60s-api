    ...
    >
      {url ? (
        ...
        React.cloneElement(icon, {
          size: iconSize || duxuiTheme.avatar.iconSize,
          color: color || duxuiTheme.avatar.color
        })
      ) : (
        <Text
          className={classNames(
            'Avatar__text Avatar--text-color',
            'Avatar__text--' + size
          )}
          style={textStyle}
        >
...
export const AvatarGroup = ({
  ...
  return (
    <View
      className={classNames('AvatarGroup', 'AvatarGroup--' + size, className)}
      style={style}
      {...props}
    >
