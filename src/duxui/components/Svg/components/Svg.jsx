            ...
            if (item?.wait) {
              ...
              if (layout.el.svgContext) {
                ...
                if (
                  value &&
                  (!elLayout ||
                    elLayout.x !== newLayout.x ||
                    elLayout.y !== newLayout.y ||
                    elLayout.width !== newLayout.width ||
                    elLayout.height !== newLayout.height)
                ) {
        ...
        const change = () => {
          if (!changeStatus) {
            const requestAnimationFrame =
              data.canvas.requestAnimationFrame || window.requestAnimationFrame;
      ...
      return (
        <>
          <Canvas
            ...
            {...event.handlers}
          />
          <SvgComponent value={{ update }}>{children}</SvgComponent>
        </>
      );
    }
  );
