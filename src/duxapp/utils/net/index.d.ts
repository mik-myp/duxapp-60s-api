...
export const chooseMedia: (
  type?: keyof Upload.Type,
  option?: Upload.GetMediaOption
) => Promise<FileItem[]>;

export const chooseMediaMiddle: (
  callback: (files: FileItem[]) => FileItem[],
  sort?: number
) => void;
...
export function createRequest(config: {
  ...
  middle: {
     ...
     */
    before: (
      callback: Request.middle['before'],
      sort: boolean,
      common: boolean
    ) => {
      remove: () => void;
     ...
     */
    result: (
      callback: Request.middle['result'],
      sort: boolean,
      common: boolean
    ) => {
      remove: () => void;
